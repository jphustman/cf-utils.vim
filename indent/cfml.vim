...
" CFML Tags:
call s:AddITags(['cfajaximport', 'cfajaxproxy', 'cfapplet', 'cfapplication',
            \   'cfassociate', 'cfbreak', 'cfcache', 'cfcalendar',
            \   'cfcase', 'cfcatch', 'cfchart', 'cfchartdata', 'cfchartseries',
            \   'cfcol', 'cfcollection', 'cfcomponent', 'cfcontent', 'cfcontinue', 'cfcookie',
            \   'cfdbinfo', 'cfdefaultcase', 'cfdirectory', 'cfdiv', 'cfdocument',
            \   'cfdocumentitem', 'cfdocumentsection', 'cfdump', 'cfelseif',
            \   'cferror', 'cfexchangecalendar', 'cfexchangeconnection', 'cfexchangecontact',
            \   'cfexchangefilter', 'cfexchangemail', 'cfexchangetask', 'cfexecute',
            \   'cfexit', 'cffeed', 'cffile', 'cffileupload', 'cffinally', 'cfflush',
            \   'cfform', 'cfformgroup', 'cfformitem', 'cfftp', 'cffunction', 'cfgrid',
            \   'cfgridcolumn', 'cfgridrow', 'cfgridupdate', 'cfheader', 'cfheader',
            \   'cfhtmlhead', 'cfhttp', 'cfhttpparam', 'cfif', 'cfimage', 'cfimap',
            \   'cfimport', 'cfindex', 'cfinsert', 'cfinterface',
            \   'cflayout', 'cflayoutarea', 'cfldap',
            \   'cflocation', 'cflock', 'cflog', 'cflogin', 'cflogout',
            \   'cfloop', 'cfmail', 'cfmailparam', 'cfmailpart', 'cfmap', 'cfmapitem',
            \   'cfmediaplayer', 'cfmenu', 'cfmenuitem', 'cfmessagebox', 'cfNTauthenticate',
            ...
            \   'cfprocessingdirective', 'cfprocparam', 'cfprocresult', 'cfprogressbar',
            \   'cfproperty', 'cfquery', 'cfregistry', 'cfreport',
            \   'cfreportparam', 'cfrethrow', 'cfsavecontent', 'cfschedule',
            \   'cfscript', 'cfsearch', 'cfselect', 'cfsetting', 'cfsharepoint',
            \   'cfsilent', 'cfslider', 'cfspreadsheet', 'cfsprydataset', 'cfstoredproc',
            \   'cfswitch', 'cftable', 'cftextarea', 'cfthread', 'cfthrow', 'cftimer',
            \   'cftooltip', 'cftrace', 'cftransaction', 'cftree', 'cftreeitem', 'cftry',
            \   'cfupdate', 'cfwddx', 'cfwindow', 'cfxml', 'cfzip', 'cfzipparam'])
"}}}
...
" CFML Remove Indent Tags:
call s:RemoveITags(['cfelse'])
"}}}
